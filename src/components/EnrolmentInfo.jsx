...
const EnrolmentInfo = () => {
  return (
    <div className="px-4 md:px-6 lg:px-12 py-16 space-y-16 max-w-[1295px] mx-auto hidden">
      <div className="flex flex-col md:flex-row justify-center md:justify-between items-center gap-12 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-[20px] font-semibold font-poppins mt-1">July 18th 2025</p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-[20px] font-semibold font-poppins mt-1">July 23rd 2025</p>
        </div>
