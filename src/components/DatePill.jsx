const DatePill = () => {
    return (
      <div className="date-pill mt-12 flex justify-center px-4">
        <div className="flex flex-col md:flex-row items-center justify-center py-6 px-4 gap-6 w-full max-w-[1312px] h-auto lg:h-[283px]">
  
          <div className="text-center now-open space-y-4">
            <p className="text-[#4E88E0] text-[24px] lg:text-[30px] font-semibold font-poppins">Now Open</p>
          ...
          <div className="text-center may-30th space-y-4">
            <p className="text-[#4E88E0] text-[24px] lg:text-[30px] font-semibold font-poppins">August 14th </p>
          ...
          <div className="text-center space-y-4">
            <p className="text-[#4E88E0] text-[24px] lg:text-[30px] font-semibold font-poppins">August 18th</p>
