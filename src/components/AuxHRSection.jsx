      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        ...
        <div className="AUX space-y-4">
          ...
          <a href="https://paystack.shop/pay/g5665008p6" target="_blank" rel="noopener noreferrer">
            <button className="bg-[#101828] w-full cursor-pointer sm:w-[197px] h-[60px] sm:h-[79px] rounded-[20px] text-white px-6 py-4 hover:bg-[#1c2e4a] font-raleway text-[20px] sm:text-[24px] font-medium mt-10">
              Enroll here
            </button>
          </a>
        </div>
