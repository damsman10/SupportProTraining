    ...
    <div className="py-16 px-4">
      <div className="flex flex-col lg:flex-row items-center justify-between lg:items-start gap-16 lg:gap-[30px] max-w-[1268px] mx-auto">
        ...
        <div className="right space-y-4 text-center lg:text-left">
          ...
          <p className="text-[16px] lg:text-[18px] w-full lg:w-[360px] mt-6 lg:mt-6 text-[#101828] font-normal font-raleway mx-auto lg:mx-0">
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center justify-center lg:justify-start gap-6 mt-6 max-w-full mx-auto">
          
          <div className="Buttons-container flex flex-col gap-4 w-[200px]">
            <a href="https://paystack.shop/pay/g5665008p6" target="_blank" rel="noopener noreferrer" className="w-full">
              <button className="bg-[#101828] font-bold font-raleway text-[20px] w-full h-[60px] text-white px-6 py-2 rounded-[10px] cursor-pointer">
                I want to enroll
              </button>
            </a>
          ...
          <div className="SVG-container relative w-[252px] h-[181px]">
            <svg
            ...
            <div className="absolute top-4 left-23 font-bold text-[24px] font-inter text-[#101828] -rotate-[12.58deg]">
              <span className="font-raleway font-bold text-[24px] block -ml-4 sm:ml-0">Just</span>
              <span className="text-[24px] font-inter font-bold block -mb-1.5 -ml-6">₦50,000</span>
              <span className="font-raleway font-bold text-[32px] block -ml-2 sm:ml-3">or</span>
              <span className="font-inter font-semibold text-[24px] block -ml-2 sm:ml-2">$50</span>
            </div>
          </div>
        </div>
